	...
	public static void main(String[] args) throws SQLException, InterruptedException {
		...
		{	int i=0;
			...
			{	i++;
				...
				s3="update stock set price="+a+"where name='"+rs.getString(2)+"'";
				s2.executeUpdate(s3);
		...
		while(rs2.next())
		{
			...
			if(bid>=mp)
			{
				...
				String s6s="insert into buy values("+tid+","+rs2.getInt(2)+",'"+rs2.getString(1)+"',"+rs2.getInt(4)+",'10-Feb-2015',"+rs2.getDouble(3)+")";
		...
		while(rs8.next())
		{
			...
			if(bid<=mp)
			{
				...
				String s16s="insert into sell values("+tid+","+rs8.getInt(2)+",'"+rs8.getString(1)+"',"+rs8.getInt(4)+",'10-Feb-2015',"+rs8.getDouble(3)+")";
