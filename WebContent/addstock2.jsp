...
<div id="tooplate_wrapper">
  ...
  <%
if(bean.URLHtml.current(request.getParameter("name"))!=null)
{
%>
...
<br><br>
<tr>
<td class="text-left"><%=request.getParameter("name")%></td>
<td class="text-left"><%=bean.URLHtml.current(request.getParameter("name"))%></td>
<TD><a href="addstockdb">Add</a></TD>
</tr>
<tr>
<%
    out.println("<iframe src='https://in.finance.yahoo.com/q?s="+request.getParameter("name")+"&ql=1' width=1000 height=500><p>Your browser does not support iframes.</p></iframe>");  

//	out.println("<iframe style='' frameborder='0' vspace='0' hspace='0' marginwidth='0' marginheight='0' scrolling='no' id='LyrIntrumentSelector' name='LyrIntrumentSelector' src='/charts/webtame/webchart.jsp?CDSymbol="+request.getParameter("name")+"&amp;Segment=CM&amp;Series=EQ&amp;CDExpiryMonth=&amp;FOExpiryMonth=&amp;IRFExpiryMonth=&amp;CDDate1=&amp;CDDate2=&amp;PeriodType=2&amp;Periodicity=1&amp;Template=tame_intraday_getQuote_closing_redgreen.jsp' width='100%' height='100%'></iframe>");
%></tr><br><br>
<%
}
else
...
<%session.setAttribute("name", request.getParameter("name"));
  session.setAttribute("price",URLHtml.current(request.getParameter("name")));
%>    	
