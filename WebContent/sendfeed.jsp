        ...
        <div id="tooplate_content">
            ...
            <div>
               ...
               <div id="contact_form">
                    ...
                    <form method="post" name="contact" action="sendfeed"> 

                                <label for="feedback">Feedback:</label> <textarea id="feedback" name="feedback" rows="0" cols="0" class="required " ></textarea>
