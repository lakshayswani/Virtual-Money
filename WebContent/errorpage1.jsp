    ...
    <div id="tooplate_header_sp">
        <div id="tooplate_menu">
            <ul>
                ...
                <li><a href="index.jsp"><span></span>Logout</a></li> </ul>    	
...
<br>
<br>
<hr><p> Stock already exists in your database !</p></hr>
<br>
<hr><p><a href="addstock.jsp">Click Here</a> to add another stock !!</p></hr>
</body>
