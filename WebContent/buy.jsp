...
<title>Make Money - Buy Stocks</title>
       ...
       %> 	
            <div>
               ...
               <div id="contact_form">
                    ...
                    if(a!=null){
                    %>
               		  <form method="post" name="contact" action="buy"> 
               	<%}else{ %>
                    <form method="post" name="contact" action="buy.jsp"> 
			...
			<option value="<%=rs1.getString(2) %>"><%=rs1.getString(2)%></option>
				<%} %>
						   ...
						   <%} %>
                            ...
                            <label for="price">Buy Price:</label> <input type="text" class="validate-subject required input_field" name="price" id="price" value="" />				               
                            <div class="cleaner h10"></div>
                  <%if(a!=null){ %>                                       
