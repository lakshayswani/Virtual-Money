            ...
            <div id="popup" style=" padding-left: 40px">
                ...
                <form class="login" name="frm1" action="signin" method="get">
                    ...
                    <table border="0" width="350">
                        <tr>
                            <td height="50" align="left" width="80" style=" color: #000000; font-size: 15px">Email</td>
            ...
            <div>
               ...
               <div id="contact_form">
                    ...
                    <form method="post" name="contact" action="signup"> 
                            ...
                            <label for="sex">Sex(M/F):</label> <input type="text" class="validate-subject required input_field" name="sex" id="sex"/>				               
                            <div class="cleaner h10"></div>
                                
                            <label for="phone">Phone:</label> <input type="text" id="phone" name="phone" class="required input_field" />
                            <div class="cleaner h10"></div>
...
<select name="yy" class="required input_field">
	...
	<option value="1947">1947</option>
                         ...
                         <label for="address">Address:</label> <textarea id="address" name="address" rows="0" cols="0" class="required"></textarea>
                            <div class="cleaner h10"></div>				                                            
